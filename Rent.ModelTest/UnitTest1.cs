...
namespace Rent.ModelTest
{
    ...
    public class UnitTestSerialization
    {
        ...
        public void TestMethodSerialize()
        {
            ...
            DataSerialization.SerializeData(@"C:\Users\User\source\repos\Organizee.UI\organizer.dat", model);
        ...
        {
            var model = DataSerialization.DeserializeItem(@"C:\Users\User\source\repos\Organizee.UI\organizer.dat");
        }
